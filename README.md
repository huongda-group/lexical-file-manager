...
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `open`    | boolean | If true, the file manager is shown.|
| `setOpen`    | (value: boolean) => void | Change state of "open" property.|
| `title`    | string | (Optional) Title of modal file manager. Default is "File Manager"|
